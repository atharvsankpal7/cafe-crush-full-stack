...
export const listOrders = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Error retrieving orders data", error: error.message });
    }
};
...
export const getOrdersSummary = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Error retrieving orders summary", error: error.message });
    }
};
